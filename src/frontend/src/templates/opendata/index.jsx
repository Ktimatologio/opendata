            ...
            <div className="dc-page-content row">
                ...
                <p>Η Πύλη Ανοιχτών Δεδομένων του ελληνικού Κτηματολογίου χρησιμοποιεί:<br/>
                  <ul>
                    ...
                    <li>το πρότυπο σχήμα https://www.w3.org/2001/XMLSchema#dateTime%22 για τις Ημερομηνίες (Created, Published, LastModified), οι οποίες έχουν τη μορφή ΥΥΥΥ-MM-DD.</li>
                    <li>το πρότυπο σχήμα του DCAT http://www.w3.org/2009/08/skos-reference/skos.html#Concept για τη δημιουργία σχήματος σχετικά με τις Κατηγορίες των Συνόλων Δεδομένων</li>
                    <li>το πρότυπο σχήμα http://purl.org/dc/terms/publisher, όπως αυτό ορίζεται στο DCAT, για την εμφάνιση του Εκδότη «Ελληνικό Κτηματολόγιο».</li>
                  </ul>
                </p>
